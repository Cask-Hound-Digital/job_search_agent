        ...
        if self.path == '/api/apply':
            ...
            try:
                ...
                payload = {
                    ...
                    "areas_of_expertise": [
                        ["Enterprise Web Strategy & Architecture: ", "Global Web Operations, CMS Governance (Sanity, AEM, WordPress, Drupal), Next-Gen DXP Modernization, Multi-National Site Performance."],
                        ...
                        ["Conversion Rate Optimization (CRO): ", "High-Velocity A/B Testing Roadmaps, Customer Experience (CX) Architecture, Multi-Site Funnel Velocity, GA4 / GTM Data Governance."],
                    ...
                    "trend_micro_bullets": [
                        ["Global Web Strategy & Operations Leadership: ", f"Led global web marketing and digital operations for {{PREVIOUS_COMPANY_1}}'s enterprise B2B and B2C portfolios, managing a 13+ person cross-functional team (Development, DevOps, QA, BA, SEO) to own the corporate web channel as the primary demand generation and pipeline engine."],
                    ...
                    "cover_letter": {
                        ...
                        "paragraphs": [
                            ...
                            "Throughout my 18-year tenure as Global Web Marketing Director of Development at {{PREVIOUS_COMPANY_1}} (June 2008 - Present), I built a high-performing global organization of 13+ cross-functional specialists (development, DevOps, QA, BA, SEO). I owned our corporate web channel as the primary demand generation engine, directing a 34-country AEM 6.x migration that reduced page load times by 40% while leading the discovery, ROI evaluation, and decision-making for a next-gen DXP platform to replace legacy AEM. Additionally, I organized and executed the TrendAI site redesign and migration to Sanity CMS, while pioneering Generative Engine Optimization (GEO/AEO) strategies that increased search visibility by 40% and lifted organic demo conversions by +15%.",
