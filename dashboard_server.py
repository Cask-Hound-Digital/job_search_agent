                ...
                payload = {
                    ...
                    "cover_letter": {
                        ...
                        "paragraphs": [
                            ...
                            "Throughout my 18-year tenure as {{YOUR_CURRENT_TITLE}} at {{PREVIOUS_COMPANY_1}} (June 2008 - Present), I built a high-performing global organization of 13+ cross-functional specialists (development, DevOps, QA, BA, SEO). I owned our corporate web channel as the primary demand generation engine, directing a 34-country AEM 6.x migration that reduced page load times by 40% while leading the discovery, ROI evaluation, and decision-making for a next-gen DXP platform to replace legacy AEM. Additionally, I organized and executed the TrendAI site redesign and migration to Sanity CMS, while pioneering Generative Engine Optimization (GEO/AEO) strategies that increased search visibility by 40% and lifted organic demo conversions by +15%.",
