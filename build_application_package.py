        ...
        if "product" in t_low or "talent" in t_low or "hr" in t_low:
            ...
            if not has_custom_expertise:
                payload["areas_of_expertise"] = [
                    ...
                    ("AI Activation & Product Innovation: ", "AI Assistant Integration (Claude, ChatGPT, Gemini, CoPilot), Automated Operations, Data & Analytics Governance."),
            ...
            payload["headline"] = f"{role.upper()} | GLOBAL MARKETING STRATEGY, CRO & AI TRANSFORMATION LEADER"
            payload["summary"] = f"Executive Digital Marketing & Growth Leader with 18+ years driving B2B marketing strategy, multi-channel demand generation, AI transformation, conversion rate optimization (CRO), and enterprise web operations. Proven track record turning corporate digital properties into high-velocity customer acquisition engines at {{MOST_RECENT_COMPANY}} (18+ years leading a 13+ person team across development, DevOps, QA, BA, and SEO). Expert in AI workflow redesign (Claude, ChatGPT, Gemini, CoPilot, MCP), team-wide prompt and governance guardrails, generative engine optimization (GEO/AEO), and {{ANALYTICS_PLATFORM}}/GTM data governance."
            if not has_custom_expertise:
                payload["areas_of_expertise"] = [
                    ("AI Transformation & Operational Workflows: ", "AI Workflow Redesign (Claude, ChatGPT, Gemini, CoPilot, MCP), Prompt & Context Structuring, Automation Capacity Planning, Time-to-Market Acceleration."),
                    ("Global Marketing Strategy & Demand Generation: ", "B2B Customer Acquisition, Full-Funnel Growth Strategy, Campaign Operations, Pipeline & Revenue Attribution."),
                    ...
                    ("AI Governance & Generative Search (GEO/AEO): ", "Team-Wide AI Policy Standards, Brand & Safety Guardrails, Generative Engine Optimization (GEO/AEO), Machine-Readable Content Models.")
                ]
        elif "e-commerce" in t_low or "ecommerce" in t_low or "storefront" in t_low or "sales" in t_low:
            payload["headline"] = f"{role.upper()} | GLOBAL E-COMMERCE, DIGITAL EXPERIENCE & AI TRANSFORMATION LEADER"
            payload["summary"] = f"Executive Digital & E-Commerce Leader with 18+ years managing enterprise web properties, direct digital storefronts, AI transformation, and cross-functional technology teams. Proven track record owning digital channels as primary demand generation and revenue engines at {{MOST_RECENT_COMPANY}} (18+ years leading global web marketing development), {{PREVIOUS_COMPANY_2}} (+34% e-commerce conversion growth), and {{PREVIOUS_COMPANY_3}} (+35% annual online sales growth). Expert in AI-assisted development workflows (Claude, ChatGPT, Gemini, CoPilot, MCP), conversion rate optimization (CRO), {{ANALYTICS_PLATFORM}}/GTM data governance, and generative engine optimization (GEO/AEO)."
            if not has_custom_expertise:
                payload["areas_of_expertise"] = [
                    ("AI Activation & Digital Innovation: ", "Generative Engine Optimization (GEO/AEO), AI Workflow Integration (Claude, ChatGPT, Gemini, CoPilot, MCP), Headless CMS Modernization ({{HEADLESS_CMS}}, {{ENTERPRISE_CMS}})."),
                    ("Enterprise E-Commerce & Web Channel Leadership: ", "Direct Digital Storefront Management, Global Web Ecosystem Operations, Multi-National Site Performance (34 Markets, 14 Languages), Customer Acquisition Velocity."),
            ...
            payload["summary"] = f"Executive Web Strategy & Technology Leader with 18+ years managing global corporate web properties, DXP architectures, AI transformation, CMS platform modernizations, and cross-functional technology teams. Proven track record owning corporate web channels as primary demand generation and pipeline engines at {{MOST_RECENT_COMPANY}} (18+ years leading a 13+ person team). Expert in AI workflow integration (Claude, ChatGPT, Gemini, CoPilot, MCP), team-wide governance guardrails, Adobe Experience Manager ({{ENTERPRISE_CMS}}), {{HEADLESS_CMS}} CMS, Next.js, {{ANALYTICS_PLATFORM}}/GTM analytics, and generative engine optimization (GEO/AEO)."
            if not has_custom_expertise:
                payload["areas_of_expertise"] = [
                    ("AI Transformation & Operational Workflows: ", "AI Workflow Redesign & Integration (Claude, ChatGPT, Gemini, CoPilot, MCP), Prompt Structuring, Team Governance Guardrails, Time-to-Market Acceleration."),
                    ("Enterprise Web Strategy & Architecture: ", "Global Web Operations, CMS Governance ({{HEADLESS_CMS}}, {{ENTERPRISE_CMS}}, WordPress), Next-Gen DXP Modernization, Multi-National Site Performance (34 Markets, 14 Languages)."),
                    ...
                    ("Optimization, CRO & Team Governance: ", "High-Velocity A/B Testing Roadmaps, Customer Experience (CX) Architecture, {{ANALYTICS_PLATFORM}} / GTM Data Governance, Cross-Disciplinary Team Leadership (13+ Dev, DevOps, QA, BA, SEO).")
                ]
...
DEFAULT_PAYLOAD = {
    ...
    "summary": "Executive Digital Marketing & Web Operations Leader with 18+ years directing enterprise web strategy, AI transformation, digital platform architecture, and cross-functional technology teams across global B2B environments. Proven track record owning the corporate digital channel as a primary demand generation engine at {{MOST_RECENT_COMPANY}} (18+ years leading a 13+ person team across development, DevOps, QA, BA, and SEO), supporting a $1.7B+ Enterprise ARR portfolio. Expert in modernizing legacy web architectures ({{ENTERPRISE_CMS}} to {{HEADLESS_CMS}} CMS), operationalizing AI workflows (Claude, ChatGPT, Gemini, CoPilot, MCP), establishing team-wide prompt and governance guardrails, and executing high-yield CRO and search optimization (SEO/GEO/AEO) programs that scale web-sourced pipeline.",
    "areas_of_expertise": [
        ("AI Transformation & Workflows: ", "AI Workflow Redesign & Integration (Claude, ChatGPT, Gemini, CoPilot, MCP), Prompt & Context Structuring, Automation Capacity Planning, Time-to-Market Acceleration."),
        ("AI Governance & Safety Guardrails: ", "Team-Wide AI Policy Standards, Brand & Compliance Safety Frameworks, Quality Control Protocols, Human-in-the-Loop Validation."),
        ("Search & AI Discovery: ", "Technical SEO, Generative Engine Optimization (GEO), Answer Engine Optimization (AEO), Machine-Readable Content Models, AI Search Presence Strategy."),
        ("Global Web Strategy & DXP Architecture: ", "Enterprise CMS / DXP ({{HEADLESS_CMS}} CMS, {{ENTERPRISE_CMS}}, WordPress), Multi-National Platform Migrations (34 Countries, 14 Languages), MarTech Architecture ({{MARKETING_AUTOMATION_TOOL}}, {{TAG_MANAGEMENT_TOOL}}, {{ANALYTICS_PLATFORM}}, GTM)."),
        ("Growth & Funnel Optimization: ", "Product-Led Growth (PLG), Conversion Rate Optimization (CRO), High-Velocity A/B Testing Roadmaps, Funnel Velocity, Data Governance."),
        ("Executive Leadership & ARR Growth: ", "Cross-Functional Team Leadership (13+ Dev, DevOps, QA, BA, SEO), Annual Planning & Budgeting ($1M+), Resource Capacity Planning, Strategic Partner Governance.")
    ],
    "trend_micro_bullets": [
        ("Enterprise ARR & Web Demand Engine: ", "Scaled corporate web channel operations to drive 35% web-sourced pipeline growth and support {{MOST_RECENT_COMPANY}}'s expansion to $1.7B+ in total Annual Recurring Revenue (ARR) and ¥276B (~$1.84B) in global net revenue."),
        ("AI Transformation & Workflow Redesign: ", "Pioneered team-wide AI transformation across global web marketing and development operations at {{MOST_RECENT_COMPANY}}, embedding AI tooling (Claude, ChatGPT, Gemini, CoPilot, MCP) into core production workflows to achieve a 35% improvement in execution velocity."),
        ...
        ("Global Web Strategy & ARR Pipeline Ownership: ", "Led global web marketing and digital operations for {{MOST_RECENT_COMPANY}}'s B2B and B2C enterprise portfolios, managing a {{TEAM_SIZE_PLACEHOLDER}} (Development, DevOps, QA, BA, SEO) to own the corporate web channel as the primary pipeline engine supporting $1.7B+ in ARR."),
...
DATABRICKS_PAYLOAD = {
    ...
    "headline": "DIRECTOR, MARKETING STRATEGY & AI TRANSFORMATION | GLOBAL DIGITAL & WEB OPERATIONS LEADER",
    "summary": "Executive Digital Marketing & Web Technology Leader with 18+ years directing enterprise web strategy, AI transformation, digital platform architecture, and cross-functional teams across global B2B portfolios. Proven track record driving end-to-end AI transformation across marketing and web operations at {{MOST_RECENT_COMPANY}}—redesigning production workflows around AI tools (Claude, ChatGPT, Gemini, CoPilot, MCP), establishing team-wide prompt and governance guardrails, and optimizing team capacity. Skilled at bridging marketing strategy, technology investments, and operational execution to deliver step-change velocity and measurable pipeline growth.",
    "areas_of_expertise": [
        ...
        ("Generative Engine Optimization (GEO/AEO): ", "Machine-Readable Content Models, AI Answer Engine Visibility (AEO/GEO), Structured Schema Standards, Search Presence Strategy."),
        ("B2B Marketing Strategy & Web Architecture: ", "Global Web Ecosystem Operations, CMS Platform Governance ({{HEADLESS_CMS}} CMS, {{ENTERPRISE_CMS}}), Multi-National Modernization (34 Markets, 14 Languages), MarTech Alignment ({{MARKETING_AUTOMATION_TOOL}}, {{TAG_MANAGEMENT_TOOL}}, {{ANALYTICS_PLATFORM}}/GTM)."),
        ("Executive Leadership & Team Governance: ", "Cross-Disciplinary Team Management (13+ Dev, DevOps, QA, BA, SEO), Annual Planning & Budgeting ($1M+), CRO & Funnel Attribution.")
    ],
    "trend_micro_bullets": [
    ...
    "cover_letter": {
        "date": "August 29, 2026",
        "recipient": "Hiring Team & VP of Marketing\nDatabricks Inc.\nSan Francisco, CA / Remote (Req ID: 8735590002)",
        "salutation": "Dear Databricks Hiring Team,",
        "paragraphs": [
            "I am writing to express my strong interest in the Director, Marketing Strategy and AI Transformation position at Databricks (Req ID: 8735590002). As {{YOUR_MOST_RECENT_TITLE}} at {{MOST_RECENT_COMPANY}} ({{MOST_RECENT_EMPLOYMENT_DATES}}), I have spent over 18 years leading global enterprise web strategy, digital platform modernizations across 34 countries, and spearheading AI transformation across marketing and web operations. Databricks’ focus on evolving marketing operations through AI transformation, workflow optimization, and scalable governance aligns directly with my executive experience.",
            "Throughout my tenure at {{MOST_RECENT_COMPANY}}, I owned the corporate web channel as a primary pipeline engine, managing a {{TEAM_SIZE_PLACEHOLDER}} across software development, DevOps, QA, business analysis, and SEO. Recognizing the transformative potential of AI, I pioneered our team’s AI adoption strategy—embedding AI tooling (Claude, ChatGPT, Gemini, CoPilot, MCP) into daily production workflows while establishing operational governance, prompt standards, and brand safety guardrails. These initiatives accelerated execution velocity by 35% while maintaining strict quality controls. Additionally, I led our Generative Engine Optimization (GEO/AEO) initiatives to structure web content for AI answer engines, lifting brand search presence by 40% and organic trial conversions by 15%. I also directed our legacy {{ENTERPRISE_CMS}} replacement onto {{HEADLESS_CMS}} CMS and led multi-national migrations across 14 languages, collaborating closely with marketing automation ({{MARKETING_AUTOMATION_TOOL}}) and GTM teams to drive 15% growth in web-sourced pipeline.",
            "Reporting to the VP of Marketing, I am eager to bring my technical web leadership, AI transformation track record, and operational governance to Databricks. I thrive in scale-oriented environments and look forward to building and leading a high-performing team that aligns marketing strategy, AI technology enablement, and resource capacity to support Databricks’ commercial growth.",
            "Thank you for your time and consideration. I welcome the opportunity to discuss how my background in enterprise web strategy, AI transformation, and cross-functional leadership will contribute to Databricks."
        ]
    }
}
...
SIXFLAGS_PAYLOAD = {
    ...
    "areas_of_expertise": [
        ("Digital Commerce & Web Architecture: ", "Enterprise Web Platforms ({{ENTERPRISE_CMS}}, {{HEADLESS_CMS}}, WordPress), E-Commerce Storefronts, Mobile App Customer Journeys, User Account Portals, Merchandising Funnels."),
    ...
    "trend_micro_bullets": [
        ...
        ("AI Technology & Content Velocity: ", "Integrated Artificial Intelligence technologies (Claude, ChatGPT, Gemini, CoPilot) into digital marketing workflows and content operations, accelerating production velocity and boosting organic conversions by 15%."),
...
GRAFANA_PAYLOAD = {
    ...
    "areas_of_expertise": [
        ...
        ("Enterprise Web Architecture & Delivery: ", "Global Web Ecosystem Architecture (grafana.com scale), Enterprise CMS Governance ({{HEADLESS_CMS}}, {{ENTERPRISE_CMS}}, WordPress), Next.js / React Platform Modernization, Performance & Reliability."),
    ...
    "trend_micro_bullets": [
        ...
        ("AI Technology Integration & Engineering Velocity: ", "Integrated Artificial Intelligence (AI) technologies (Claude, ChatGPT, Gemini, CoPilot) into web engineering and content production workflows, accelerating development velocity by 30% and reducing coordination overhead."),
...
NEO_SECURITY_PAYLOAD = {
    ...
    "areas_of_expertise": [
        ...
        ("Enterprise B2B SaaS Web Architecture: ", "Corporate Site Architecture, CMS Governance ({{HEADLESS_CMS}}, {{ENTERPRISE_CMS}}, WordPress), Landing Page Velocity, Conversion Rate Optimization (CRO), A/B Testing Roadmaps."),
...
CERIFI_PAYLOAD = {
    ...
    "areas_of_expertise": [
        ("Website Architecture & Funnel Optimization: ", "Global Website Ecosystem Management, Landing Page Velocity, CMS Governance ({{HEADLESS_CMS}}, {{ENTERPRISE_CMS}}, WordPress), Multi-National Site Performance."),
        ...
        ("AI Activation & Digital Innovation: ", "Generative Engine Optimization (GEO/AEO), AI Coding & Tool Integration (Claude, ChatGPT, Gemini, CoPilot), Automated Personalization."),
...
TWENTYFOUR_SEVEN_PAYLOAD = {
    ...
    "areas_of_expertise": [
        ...
        ("Conversion Rate Optimization (CRO) & CX Architecture: ", "High-Yield A/B & Multivariate Testing, Checkout Funnel Optimization, {{ANALYTICS_PLATFORM}} & GTM Attribution, Personalization Guardrails."),
        ("AI Activation & Digital Innovation: ", "Generative Engine Optimization (GEO/AEO), AI Coding & Tool Integration (Claude, ChatGPT, Gemini, CoPilot), Headless CMS Modernization ({{HEADLESS_CMS}}, {{ENTERPRISE_CMS}})."),
        ("Executive Leadership & Governance: ", "Cross-Disciplinary Team Management (13+ Dev, DevOps, QA, BA, SEO), Agile Sprint Execution, Budget Management ($1M+), Strategic Partner Management.")
    ],
    "trend_micro_bullets": [
...
{{TARGET_COMPANY_3}}_PAYLOAD = {
    ...
    "areas_of_expertise": [
        ...
        ("AI Integration & Digital Innovation: ", "Generative Engine Optimization (GEO/AEO), AI-Assisted Marketing Workflows (Claude, ChatGPT, Gemini, CoPilot), Automated Personalization & Analytics."),
...
{{TARGET_COMPANY_2}}_FVP_PAYLOAD = {
    ...
    "areas_of_expertise": [
        ...
        ("AI Activation & Emerging MarTech: ", "Generative Engine Optimization (GEO/AEO), AI-Assisted Workflows (Claude, ChatGPT, Gemini, CoPilot), Next-Gen DXP / Headless CMS Modernization."),
