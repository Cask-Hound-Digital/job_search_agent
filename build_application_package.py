...
def verify_payload_tailoring(payload):
    ...
    if is_generic:
        ...
        if "product" in t_low or "talent" in t_low or "hr" in t_low:
            ...
            if not has_custom_expertise:
                payload["areas_of_expertise"] = [
                    ("Enterprise Web Strategy & Architecture: ", "Global Web Operations, CMS Governance ({{HEADLESS_CMS}}, {{ENTERPRISE_CMS}}, WordPress), Next-Gen DXP Modernization, Multi-National Site Performance."),
                    ("AI Activation & Digital Innovation: ", "Generative Engine Optimization (GEO/AEO), AI-Assisted Workflows (Claude, ChatGPT, Gemini, CoPilot), Automated Personalization & Analytics."),
