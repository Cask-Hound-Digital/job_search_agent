...
DATABRICKS_PAYLOAD = {
    ...
    "areas_of_expertise": [
        ...
        ("AI Agent Orchestration & Workflow Velocity: ", "AI Agent Orchestration & Autonomous Tooling (Google Antigravity, MCP, Claude, ChatGPT, CoPilot), Prompt Engineering, Automated Analytics Reporting, Web Production Velocity."),
        ("Enterprise AI Governance & Compliance: ", "Enterprise AI Policy Guardrails, Brand Safety Frameworks, Human-in-the-Loop Validation, Data Privacy & Security Standards."),
        ("Enterprise Platform & MarTech Architecture: ", "Global Platform Migrations (34 Countries, 14 Languages), Adobe Experience Manager ({{ENTERPRISE_CMS}}), {{HEADLESS_CMS}}, WordPress, Drupal, {{TAG_MANAGEMENT_TOOL}}, {{ANALYTICS_PLATFORM}}, GTM, REST APIs, Marketing Automation Team Collaboration ({{MARKETING_AUTOMATION_TOOL}})."),
    ...
    "trend_micro_bullets": [
        ...
        ("AI Agent Orchestration & Governance Guardrails: ", "Engineered autonomous AI agent workflows (Claude, ChatGPT, CoPilot, MCP) and established enterprise AI governance guardrails, ensuring compliance, brand safety, and data security while accelerating web development velocity by 35%."),
        ...
        ("AI Technology Integration & Conversion Lift: ", "Integrated Artificial Intelligence (AI) technologies into web production and analytics reporting workflows, accelerating development velocity and contributing to a 15% uplift in organic demo/trial conversions."),
        ("Multi-National Platform & MarTech Collaboration: ", "Led large-scale platform migration and operating model transition across 34 countries and 14 languages, collaborating with {{MARKETING_AUTOMATION_TOOL}} marketing automation teams and integrating {{TAG_MANAGEMENT_TOOL}}, GTM, and Google Analytics to improve page load time by 40%, increase organic sessions by 10%, and drive 15% growth in web-sourced pipeline."),
    ...
    "cover_letter": {
        ...
        "paragraphs": [
            "I am writing to express my strong candidacy for the {{YOUR_TARGET_ROLE_3}} position at Databricks (Job ID: 8638642002). As {{YOUR_MOST_RECENT_TITLE}} at {{MOST_RECENT_COMPANY}} ({{MOST_RECENT_EMPLOYMENT_DATES}}), I have spent over 18 years leading enterprise web strategy, multi-national platform migrations across 34 countries, AI Agent orchestration, and enterprise AI governance. Databricks’ vision to evolve its web properties to serve both human visitors and AI agents aligns perfectly with my background in structuring machine-readable web content, scaling Generative Engine Optimization (GEO), establishing AI guardrails, and operationalizing web development velocity.",
            "Throughout my tenure at {{MOST_RECENT_COMPANY}}, I have owned the global web channel as a primary pipeline engine. Recognizing the shift toward AI-driven discovery, I pioneered our Generative Engine Optimization (GEO) and Answer Engine Optimization (AEO) strategies, increasing company presence across AI search engines by 40% while lifting organic demo/trial conversions by 15%. Additionally, I engineered AI agent workflows (Claude, ChatGPT, CoPilot, MCP) paired with strict enterprise AI governance guardrails for brand safety and compliance. I also led a large-scale platform migration across 14 languages, collaborating with {{MARKETING_AUTOMATION_TOOL}} marketing automation teams and integrating {{TAG_MANAGEMENT_TOOL}} and Google Analytics, improving page load speed by 40% and driving 15% growth in web-sourced pipeline.",
            "Reporting to the VP of Marketing, I am eager to bring my deep technical experience, AI agent orchestration vision, and team governance to Databricks. I thrive in scale-oriented environments and look forward to building a high-performing web product organization that turns Databricks’ global web presence into an unmatched commercial and AI-native growth engine.",
            "Thank you for your time and consideration. I welcome the opportunity to discuss how my experience in web strategy, AI Agent orchestration, enterprise AI governance, and digital leadership will drive immediate impact for Databricks."
        ]
    }
}
