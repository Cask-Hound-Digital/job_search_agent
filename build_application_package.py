...
DATABRICKS_PAYLOAD = {
    ...
    "summary": "Executive Digital Marketing & Web Operations Leader with 18+ years directing global enterprise web strategy, digital platform architecture, and cross-functional technology teams across B2B and B2C portfolios. Proven track record owning the corporate digital channel as a primary demand generation engine at {{MOST_RECENT_COMPANY}} (18+ years leading a 13+ person team across development, DevOps, QA, BA, and SEO). Expert in modernizing legacy web architectures ({{ENTERPRISE_CMS}} to {{HEADLESS_CMS}} CMS), operationalizing AI workflows (Claude, ChatGPT, CoPilot, MCP), and building scalable governance frameworks that optimize capacity and accelerate time-to-market.",
    "areas_of_expertise": [
        ("Enterprise Web Strategy & Architecture: ", "Global Digital Operations, CMS Governance ({{HEADLESS_CMS}} CMS, {{ENTERPRISE_CMS}}, WordPress, Drupal), Next-Gen DXP Modernization, Multi-National Site Performance (34 Markets, 14 Languages)."),
        ("AI Activation & Operational Workflows: ", "Generative Engine Optimization (GEO/AEO), AI-Assisted Development Workflows (Claude, ChatGPT, CoPilot, MCP), Automated Personalization & Analytics."),
        ("Marketing Strategy & Resource Planning: ", "Cross-Functional Capacity Planning (Dev, Marketing, Agencies), Annual Web Strategy & Roadmaps, Budget Management ($1M+), Pipeline & Funnel Measurement."),
        ("Optimization, CRO & Governance: ", "Conversion Rate Optimization (CRO), High-Velocity A/B Testing Roadmaps, {{ANALYTICS_PLATFORM}} / GTM Data Governance, Cross-Disciplinary Team Management (13+ Dev, DevOps, QA, BA, SEO).")
    ],
    "trend_micro_bullets": [
        ("Global Web Strategy & Operations Leadership: ", "Led global web marketing and digital operations for {{MOST_RECENT_COMPANY}}'s B2B and B2C enterprise portfolios, managing a {{TEAM_SIZE_PLACEHOLDER}} (Development, DevOps, QA, BA, SEO) to own the corporate web channel as the primary demand generation and pipeline engine."),
        ("Next-Gen DXP Discovery & Platform Modernization: ", "Led discovery, architectural evaluation, ROI analysis, and executive vendor decision-making to replace legacy Adobe Experience Manager ({{ENTERPRISE_CMS}}), organizing the redesign and migration of core web properties onto {{HEADLESS_CMS}} CMS with structured content models and headless workflows."),
        ("AI Workflow Integration & Production Velocity: ", "Championed AI adoption (Claude, ChatGPT, CoPilot, MCP) across development and marketing operations, establishing prompt guidelines and operational guardrails that improved team production velocity by 35%."),
        ("Generative Engine Optimization (GEO/AEO): ", "Pioneered Generative Engine Optimization (GEO) and Answer Engine Optimization (AEO) strategies across global web properties, structuring content for machine readability to boost brand presence across traditional and AI search platforms by 40% and lift organic conversions by 15%."),
        ...
        ("Unified Team Governance & Resource Planning: ", "Established a common collaboration framework for Developers, Marketers, Editors, and External Agencies, aligning capacity planning and intake workflows to elevate execution quality and operational efficiency."),
    ...
    "cover_letter": {
        ...
        "paragraphs": [
            "I am writing to express my strong interest in the Director, Marketing Strategy and AI Transformation position at Databricks (Req ID: 8735590002). As {{YOUR_MOST_RECENT_TITLE}} at {{MOST_RECENT_COMPANY}} ({{MOST_RECENT_EMPLOYMENT_DATES}}), I have spent over 18 years leading global enterprise web strategy, digital platform modernizations across 34 countries, and integrating AI-driven workflows into marketing and web operations. Databricks’ focus on evolving marketing operations through AI transformation, workflow optimization, and scalable governance aligns directly with my executive experience.",
            "Throughout my tenure at {{MOST_RECENT_COMPANY}}, I owned the corporate web channel as a primary pipeline engine, managing a {{TEAM_SIZE_PLACEHOLDER}} across software development, DevOps, QA, business analysis, and SEO. Recognizing the shift toward AI-assisted workflows, I championed the adoption of AI tooling (Claude, ChatGPT, CoPilot, MCP) paired with clear operational guidelines and prompt standards, driving a 35% improvement in development velocity. Additionally, I led the architectural evaluation and migration from legacy Adobe Experience Manager ({{ENTERPRISE_CMS}}) to {{HEADLESS_CMS}} CMS, establishing structured content models and Generative Engine Optimization (GEO/AEO) strategies that boosted brand search presence by 40% and lifted organic conversions by 15%. I also led multi-national platform modernizations across 14 languages, collaborating closely with marketing automation ({{MARKETING_AUTOMATION_TOOL}}) and demand generation teams to drive 15% growth in web-sourced pipeline.",
            "Reporting to the VP of Marketing, I am eager to bring my technical web leadership, team governance, and practical AI transformation vision to Databricks. I thrive in scale-oriented environments and look forward to building and leading a high-performing team that aligns marketing strategy, technology investments, and operational efficiency to support Databricks’ commercial growth.",
            "Thank you for your time and consideration. I welcome the opportunity to discuss how my background in enterprise web strategy, AI workflow integration, and cross-functional leadership will contribute to Databricks."
        ]
    }
}
