...
DATABRICKS_PAYLOAD = {
    ...
    "trend_micro_bullets": [
        ("AI Transformation & Operational Workflow Redesign: ", "Pioneered team-wide AI transformation across global web marketing and development operations at {{MOST_RECENT_COMPANY}}, embedding AI tooling (Claude, ChatGPT, CoPilot, MCP) into core production workflows to achieve a 35% improvement in execution velocity."),
