...
DATABRICKS_PAYLOAD = {
    ...
    "headline": "DIRECTOR, MARKETING STRATEGY & AI TRANSFORMATION | GLOBAL GTM, AI AGENTS & MCP INTEGRATION LEADER",
    "summary": "Strategic B2B Marketing & AI Transformation Executive with 18+ years leading enterprise marketing strategy, marketing capacity modeling, AI Agent orchestration, and enterprise AI governance. Proven track record redesigning high-leverage marketing workflows around modern agent frameworks and MCP-based integrations (Model Context Protocol) to achieve step-change improvements in time-to-market. Expert in aligning marketing investment strategy against strategic bets, establishing org-wide prompt and context standards, and enforcing AI safety, quality, and risk guardrails across matrixed organizations.",
    "areas_of_expertise": [
        ("AI Agent Orchestration & MCP Frameworks: ", "Agentic Workflow Engineering, MCP-Based Integrations (Model Context Protocol), Modern Agent Frameworks, Prompt Engineering & Context Structuring, Time-to-Market Velocity."),
        ("Enterprise AI Governance & Safety Guardrails: ", "Org-Wide Prompt & Context Standards, AI Quality & Risk Guardrails, Responsible Use Policy, Data Privacy & Safety Standards, High-Yield AI Adoption."),
        ("B2B Marketing Strategy & Investment Allocation: ", "Annual Marketing Planning, Resource Capacity Modeling (People, Agencies, AI Agents), Spend & Investment Optimization, Pipeline & Revenue Attribution."),
        ("Enterprise MarTech & Cross-Functional Operations: ", "Enterprise Marketing Stack Alignment (CRM, CDP, BI, Web Platforms), Demand Gen Alignment, GTM Strategy, Cross-Functional Team Leadership (13+ Dev, Marketing, Ops)."),
        ("Global Web Strategy & Machine Readability: ", "Global Web Ecosystem Architecture, AI Agent & Answer Engine Optimization (GEO/AEO), Structured Content Standards, Multi-National Site Performance.")
    ],
    "trend_micro_bullets": [
        ("AI Agent Orchestration & MCP Workflow Redesign: ", "Engineered autonomous AI agent workflows (Claude, ChatGPT, CoPilot, MCP) and agentic integrations, redesigning core marketing operations to achieve a step-change 35% improvement in time-to-market velocity."),
        ("Enterprise AI Governance & Risk Guardrails: ", "Established org-wide AI governance standards, prompt/context structuring guidelines, and responsible-use guardrails, scaling AI agent adoption safely across cross-functional marketing and web teams."),
        ("Marketing Capacity Modeling & Investment Strategy: ", "Developed comprehensive capacity modeling spanning internal teams, agency partners, and AI agent execution, aligning marketing investment and spend toward high-impact strategic bets and pipeline growth."),
        ("Global B2B Web Channel & Demand Engine: ", "Led global digital operations for {{MOST_RECENT_COMPANY}}'s B2B enterprise portfolio (18+ years), owning the corporate web channel as the primary demand generation and pipeline engine across development, operations, analytics, and marketing."),
        ("Generative Engine Optimization (GEO/AEO): ", "Pioneered SEO, Generative Engine Optimization (GEO), and Answer Engine Optimization (AEO) across global web properties, structuring machine-readable content to boost brand presence across traditional and AI search engines by 40%."),
        ("Multi-National Platform & MarTech Collaboration: ", "Directed enterprise platform migration across 34 countries and 14 languages, collaborating with marketing automation ({{MARKETING_AUTOMATION_TOOL}}) and GTM teams while integrating {{TAG_MANAGEMENT_TOOL}}, GTM, and {{ANALYTICS_PLATFORM}} to reduce page load time by 40% and drive 15% pipeline growth."),
        ...
        ("Cross-Functional Campaign & Alignment Framework: ", "Partnered closely with product marketing, demand generation, UX design, and regional teams to align digital experiences with global campaigns, enabling integrated launches and boosting landing-page conversion by 10%."),
    ...
    "cover_letter": {
        "date": "August 29, 2026",
        "recipient": "Hiring Team & VP of Marketing Strategy\nDatabricks Inc.\nSan Francisco, CA / Remote (Req ID: 8735590002)",
        "salutation": "Dear Databricks Hiring Team,",
        "paragraphs": [
            "I am writing to express my enthusiastic candidacy for the Director, Marketing Strategy and AI Transformation position at Databricks (Req ID: 8735590002). As {{YOUR_MOST_RECENT_TITLE}} at {{MOST_RECENT_COMPANY}} ({{MOST_RECENT_EMPLOYMENT_DATES}}), I have spent over 18 years leading B2B enterprise marketing strategy, AI Agent orchestration, MCP-based integrations, and enterprise AI governance. Databricks’ mission to drive org-wide agent adoption, build agentic marketing workflows, and establish robust AI safety guardrails aligns directly with my executive experience operationalizing AI transformation at scale.",
            "Throughout my tenure at {{MOST_RECENT_COMPANY}}, I have owned the global digital channel as a primary demand and pipeline engine. Recognizing the shift toward agentic execution, I engineered autonomous AI agent workflows (Claude, ChatGPT, CoPilot, MCP) and established org-wide prompt, context, and governance standards. These initiatives delivered a step-change 35% improvement in development velocity while ensuring strict quality, brand safety, and risk guardrails. Furthermore, I built marketing capacity models spanning internal teams, agency partners, and AI agent execution to optimize investment allocation, align spend with high-impact strategic bets, and lift organic demo/trial conversions by 15%. I also led multi-national platform modernizations across 34 countries and 14 languages, collaborating with marketing automation ({{MARKETING_AUTOMATION_TOOL}}) and GTM teams to drive 15% growth in web-sourced pipeline.",
            "Reporting to the VP of Marketing, I am eager to bring my deep strategic experience, capacity modeling expertise, and hands-on AI Agent and MCP orchestration vision to Databricks. I thrive in scale-oriented environments and look forward to building a high-performing team from the ground up that turns Databricks’ marketing strategy and AI transformation into an unmatched growth engine.",
        ]
    }
}
